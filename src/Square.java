...
public class Square extends Enemy
{
  ...
  public Square(Player p, int col) {
    if (col == 0) {
  ...
  public void paint(Graphics gg) {
    if (!this.isDEAD) {
      if (this.count < 5) {
        ...
        gg.drawLine(x1 + (int)((this.count / 2 + 1) * Math.cos(Math.toRadians(this.theta + 90))), y1 - (int)((this.count / 2 + 1) * Math.sin(Math.toRadians(this.theta + 90))), x3 + (int)((this.count / 2 + 1) * Math.cos(Math.toRadians(this.theta))), y3 - (int)((this.count / 2 + 1) * Math.sin(Math.toRadians(this.theta))));
        gg.drawLine(x1 - (int)((this.count / 2 + 1) * Math.cos(Math.toRadians(this.theta + 90))), y1 + (int)((this.count / 2 + 1) * Math.sin(Math.toRadians(this.theta + 90))), x4 + (int)((this.count / 2 + 1) * Math.cos(Math.toRadians(this.theta))), y4 - (int)((this.count / 2 + 1) * Math.sin(Math.toRadians(this.theta))));
      } else {
        gg.setColor(this.xx);
        ...
        gg.drawLine(x1 + (int)(9.0D * Math.cos(Math.toRadians(this.theta + 90))), y1 - (int)(9.0D * Math.sin(Math.toRadians(this.theta + 90))), x3 + (int)(9.0D * Math.cos(Math.toRadians(this.theta))), y3 - (int)(9.0D * Math.sin(Math.toRadians(this.theta))));
        gg.drawLine(x1 - (int)(9.0D * Math.cos(Math.toRadians(this.theta + 90))), y1 + (int)(9.0D * Math.sin(Math.toRadians(this.theta + 90))), x4 + (int)(9.0D * Math.cos(Math.toRadians(this.theta))), y4 - (int)(9.0D * Math.sin(Math.toRadians(this.theta))));
      }
    } else if (this.deadCOUNT > 1) {
      for (ExplosionShot e : this.explosion) {
        e.paint(gg);
