...
public class MiniDiamond extends Enemy {
  int theta = 0;
  int moveDIST = 4;
  float hue = 0.82F;
  ...
  public MiniDiamond(int x, int y, boolean side, int col) {
    if (col == 0) {
  ...
  public void paint(Graphics gg) {
    if (!this.isDEAD) {
      ...
      int x3 = this.myX - (int)(8.0D * Math.cos(Math.toRadians(this.theta + 90)));
      int y3 = this.myY + (int)(8.0D * Math.sin(Math.toRadians(this.theta + 90)));
      int x4 = this.myX + (int)(8.0D * Math.cos(Math.toRadians(this.theta + 90)));
      int y4 = this.myY - (int)(8.0D * Math.sin(Math.toRadians(this.theta + 90)));
